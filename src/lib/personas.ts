...
${callType === 'discovery' ? `You're curious and you have real pain. You'll share your situation when asked — you're not guarded. You want to know if this is something worth exploring further, but you're not going to say that unless they've asked the right questions. If the call goes well, you might say something like "okay this is interesting, let's figure out next steps."` : `You've already shared the core situation. You're excited to see the product in action. You want to see what the note looks like after an interview, how it pushes into Ashby, and what the candidate experience looks like (you're a little nervous about them feeling watched).`}
...
${callType === 'discovery' ? `You're open but skeptical. You want to know: does this actually work at your scale, does it work with Greenhouse, and what does adoption realistically look like? If they've done their job well, you're open to talking more — but you're not going to drive that conversation yourself.` : `You've shared the setup — inconsistent feedback, scorecard gap, TTH problem. You want to see the product. You'll ask about Greenhouse integration specifically and you want to see real data on what notes look like. You'll bring up adoption: "I've seen dashboards with zero data because nobody used the tool. How is this different?"`}
...
${callType === 'discovery' ? `You agreed to this call to figure out whether MetaView is worth any more of your time. You'll say early: "The thing I care most about is whether this can give me interviewer-level performance data. That's the primary use case I'm evaluating." You won't give up your other pain points unless they ask smart questions. You'll test their Ashby knowledge.` : `You've shared the primary problem: offer acceptance gap and interviewer visibility. You agreed to a follow-up. You want to see the reporting piece first. You'll push on what adoption actually looks like with numbers, not anecdotes. You'll want to understand rollout: what does a Decagon hiring manager experience, step by step, the first time they interact with MetaView.`}
