...
The AE is ${vp.name.includes('Trisha') ? 'the user' : 'Trisha'}. Evaluate their performance rigorously against the rubric. For the "Stakeholder awareness" category specifically, analyze:
